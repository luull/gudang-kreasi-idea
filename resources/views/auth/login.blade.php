...
<head>
    ...
    <title>Gudang Kreatif Idea | Login </title>
...
<body class="form" style="background-color: #eaeaea">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Login</h1>
                        <hr>
                        <img src="{{ asset('admin/assets/img/icon.png') }}" class="img-fluid" style="max-height: 150px"
                            alt="">

                        <form class="text-left" action="{{ route('proses-login') }}" method="POST">
                            @csrf
                            <div class="form">
                                ...
                                @if (session('message'))
                                    <div class="alert alert-arrow-left alert-icon-left {{ session('color') }} mb-4"
                                        role="alert">
