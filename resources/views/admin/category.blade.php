        ...
        <table id="dt" class="table dt-table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $category->name }}</td>
                    <td><img src="{{ asset($category->image) }}" width="100px" class="img-thumbnail"></td>
                    <td>{{ $category->description }}</td>
                    <td>
                        <a href="#" class="edit btn btn-outline-primary mr-2 mb-2" id="e-{{ $category->id }}"
                            alt="Edit"><i class="fa fa-edit"></i></a>
                        <a href="/admin/category/delete/{{ $category->id }}" class="btn btn-outline-danger mb-2"><i
...
@section('modal_add')
<form action="{{ route('proses-add-category') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @error('image')
                    <br>
                    <div class="text-danger mt-1">Image does not meet the requirements</div>
                    @enderror
                </div>
            </div>
            <div class="col-md-12">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal"><i data-feather="cancel"></i> Cancel</button>
...
@section('modal_edit')
<form action="{{ route('proses-edit-category') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<script>
    // Include your JavaScript for edit and delete functionality here
