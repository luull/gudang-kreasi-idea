                ...
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/admin/banner/delete/{{ $d->id }}" class="btn btn-outline-danger mb-2"><i
...
@section('modal_add')
    <form action="{{ route('proses-add-banner') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
@endsection
@section('modal_edit')
    <form action="{{ route('proses-edit-banner') }}" method="POST" enctype="multipart/form-data">
        @csrf
