...
@section('modal_add')
    <form action="{{ route('proses-add-admin') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @error('username')
                            <div class="text-danger mt-1 mb-1">username is required</div>
                        @enderror
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @error('password')
                            <div class="text-danger mt-1 mb-1">password is required</div>
                        @enderror
                    </div>
                </div>
            </div>
...
@endsection
@section('modal_edit')
    <form action="{{ route('proses-edit-admin') }}" method="POST" enctype="multipart/form-data">
        @csrf
