                ...
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td>
                            ...
                            <!--<a href="/admin/link/delete/{{ $d->id }}" class="btn btn-outline-danger mb-2"><i-->
...
@section('modal_add')
    <form action="{{ route('proses-add-link') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Menu</label>
                        <select name="menu" class="form-control" id="" value="{{ old('menu') }}">
...
@endsection
@section('modal_edit')
    <form action="{{ route('proses-edit-link') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Menu</label>
                            <input type="text" name="menu" class="form-control" id="edit_menu" hidden>
                        <select class="form-control" id="edit_menu"  disabled>
                            <option value="jurnal">Jurnal</option>
                            <option value="katalog">Katalog</option>
                        </select>
                        @error('menu')
